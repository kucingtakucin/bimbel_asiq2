...
<section class="text-gray-400 bg-gray-900 body-font">
    <div class="container px-5 py-32 mx-auto">
        <div class="flex flex-col text-center w-full mb-12">
            <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-white">Form Ubah Data Mentor</h1>
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            type: 'GET',
            url: `<?= route_to('admin.guru.show', $guru->id) ?>`,
            headers: {
        ...
        $('#form_admin_guru').submit(function(event) {
            ...
            $.ajax({
                url: '<?= route_to('admin.guru.update', $guru->id) ?>',
                type: 'POST',
                data: formData,
                headers: {
                    'X-Requested-With': 'XMLHttpRequest',
