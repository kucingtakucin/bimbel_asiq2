...
<section class="text-gray-400 bg-gray-900 body-font">
    <div class="container px-5 py-32 mx-auto">
        <div class="flex flex-col text-center w-full mb-12">
            <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-white">Form Tambah Siswa</h1>
        ...
        <form id="form_admin_siswa" method="post">
            ...
            <div class="flex lg:w-2/3 w-full sm:flex-row flex-col mx-auto px-8 sm:px-0 items-end sm:space-x-4 sm:space-y-0 space-y-4">
                ...
                <div class="relative sm:mb-0 flex-grow w-full">
                    ...
                    <select name="id_kelas" id="id_kelas" class="w-full bg-gray-800 bg-opacity-40 rounded border border-gray-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-900 focus:bg-transparent text-base outline-none text-gray-100 py-1 px-2 transition-colors duration-200 ease-in-out">
                    </select>
                    <div class="text-sm font-bold text-red-500 mt-1 validation" id="error_id_kelas"></div>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#form_admin_siswa').submit(function(event) {
            ...
            $.ajax({
                url: '<?= route_to('admin.siswa.create') ?>',
                type: 'POST',
                headers: {
